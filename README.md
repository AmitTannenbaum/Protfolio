...
A comprehensive analysis of vehicle health data with interactive Tableau dashboard.

**Technologies**: Python, Jupyter Notebook, Tableau, Pandas, Data Visualization

**Highlights**:
- Data cleaning and preprocessing
- Statistical analysis of vehicle health metrics
- Interactive Tableau dashboard for stakeholder presentation
- Product requirements documentation

[📊 View Tableau Dashboard](https://public.tableau.com/views/product_owner_dataanalyst_home_assignment/VehicleHealthManagementSystem)
